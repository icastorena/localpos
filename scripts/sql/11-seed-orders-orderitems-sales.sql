-- ========================================
-- Seed Orders, Order Items and Sales Report
-- ========================================

-- ORDERS
INSERT INTO orders.orders (id, user_id, store_id, total_amount, status, created_at, updated_at) VALUES
  ('8c138a9c-bb6a-40ca-81ef-2dfde9b03c79', 'b2cb3e13-6b32-4b81-8a37-fc0b37aa5db4', '1bb3b69f-62d2-4b52-b8c2-8355057e8d60', 10.00, 'COMPLETED', NOW(), NOW()),
  ('2d863b0a-24ec-4fdb-9d63-4c5a9ae1226b', '704a1fc9-b42e-4f7c-9bfc-53309a31e50b', '963e2cb6-8f97-4e6c-91c1-03b70f195911', 7.50, 'COMPLETED', NOW(), NOW()),
  ('d1a15dbd-0fcd-44e3-8b88-e4c4f0b3e9b9', 'dd6a8d38-9d0a-4ea2-b04c-cd5ff5ff1d82', '963e2cb6-8f97-4e6c-91c1-03b70f195911', 6.00, 'PENDING', NOW(), NOW())
